...
@Data
public class EditionRequestDTO extends GenericDTO<Long> {
    ...
    private ThemeRequestDTO defaultDarkTheme;

    @ManyToOne
    @JoinColumn(name = "default_light_theme_id")
    private ThemeRequestDTO defaultLightTheme;

    @ManyToOne
    @JoinColumn(name = "logo_id")
    private FileRequestDTO logo;
